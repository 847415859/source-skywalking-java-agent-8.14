...
public class WebFluxWebClientInterceptor implements InstanceMethodsAroundInterceptorV2 {
    ...
    private static final ILog LOGGER = LogManager.getLogger(WebFluxWebClientInterceptor.class);

    @Override
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, MethodInvocationContext context) throws Throwable {
        LOGGER.info("WebFluxWebClientInterceptor.before do....");
    }
    ...
    public Object afterMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, Object ret, MethodInvocationContext context) throws Throwable {
        ...
        return Mono.subscriberContext().flatMap(ctx -> {
            ...
            return ret1.doOnSuccess(clientResponse -> {
                ...
                LOGGER.info("Response Header: {}", clientResponse.headers().asHttpHeaders());
                LOGGER.info("Find ME, TRACE-ID:{}", ContextManager.getGlobalTraceId());
                clientResponse.headers().asHttpHeaders().add("DD-TRACE", ContextManager.getGlobalTraceId());
                LOGGER.info("Response Header: {}", clientResponse.headers().asHttpHeaders());
                clientResponse.headers().asHttpHeaders().add("DD-TRACE-ID", ContextManager.getGlobalTraceId());
